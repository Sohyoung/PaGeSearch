...
def main(argv):
    ...
    parser.add_argument('-o', '--outdir', dest='outdir', type=str, action="store", default='./pathway')

    args = parser.parse_args()

    if args.pathway != '':
        gene_pathway_file_path = f"/disk1/1.Sohyoung_Pipeline/Data/Ensembl/{args.species}_reactome_genes_only.txt"
        download_pathway_genes(args.pathway, args.species, args.taxonid, args.outdir)
    if args.genelist != '':
